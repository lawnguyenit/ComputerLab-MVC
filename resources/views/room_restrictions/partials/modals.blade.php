<!-- Modal Xóa lịch cấm sử dụng phòng -->
        ...
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between align-items-center" style="background-color:rgb(196, 9, 9); color: #ffffff;">
                <h4 class="modal-title m-0" id="deleteModalLabel" style="color: #ffffff;">
                    <i class="fas fa-trash-alt me-2"></i> Xóa lịch cấm sử dụng phòng
                </h4>
            </div>
            <div class="modal-body">
                <p>Bạn có chắc chắn muốn xóa lịch cấm sử dụng phòng này không?</p>
...
<!-- Modal Thêm lịch cấm sử dụng phòng -->
        ...
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between align-items-center" style="background-color: #28a745; color: #ffffff;">
                <h4 class="modal-title m-0" id="addModalLabel" style="color: #ffffff;">
                    <i class="fas fa-plus-circle"></i> Thêm lịch cấm sử dụng phòng
                </h4>
            </div>
            <form action="{{ route('room-restrictions.store') }}" method="POST" id="addForm">
                @csrf
                <div class="modal-body"> 
...
<!-- Modal Chỉnh sửa lịch cấm sử dụng phòng -->
        ...
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between align-items-center" style="background-color:rgb(42, 5, 122); color: #ffffff;">
                <h4 class="modal-title m-0" id="editModalLabel" style="color: #ffffff;">
                    <i class="fas fa-edit me-2"></i> Cập nhật lịch cấm sử dụng phòng
                </h4>
            </div>
            <form action="" method="POST" id="editForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="edit_noi_dung_cam_su_dung" name="noi_dung_cam_su_dung" required>
                    </div>
        ...
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between align-items-center" style="background-color: #fd7e14; color: #ffffff;">
                <h4 class="modal-title m-0" id="importModalLabel" style="color: #ffffff;">
                    <i class="fas fa-file-import me-2"></i> Import lịch cấm sử dụng phòng từ Excel
                </h4>
            </div>
            <form action="{{ route('room-restrictions.import') }}" method="POST" enctype="multipart/form-data" id="importForm">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        <ul class="mb-0">
                            ...
                            <li>Dữ liệu phải theo đúng mẫu (Tên phòng, Nội dung cấm sử dụng, Thời gian bắt đầu, Thời gian kết thúc)</li>
                            <li>Thời gian phải theo định dạng YYYY-MM-DD HH:MM:SS</li>
                        </ul>
                    </div>
                    <div class="mt-3">
                        <a href="{{ route('room-restrictions.template') }}" class="btn btn-sm btn-outline-primary">
