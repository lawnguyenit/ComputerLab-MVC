...
<head>
    ...
    <title>Quên mật khẩu - Hệ thống quản lý phòng máy</title>
...
<body>
    <div class="forgot-container">
        <div class="card">
            <div class="row g-0">
                <div class="col-md-6 forgot-side">
                    <div class="card-body">
                        <div class="text-center mb-4">
                            <i class="fas fa-key fa-3x mb-3 text-primary"></i>
                            <h4 class="forgot-title">QUÊN MẬT KHẨU</h4>
                            <p class="text-muted">Vui lòng nhập địa chỉ email của bạn để nhận liên kết đặt lại mật khẩu.</p>
                        </div>
                ...
                <div class="col-md-6 image-side">
                    <div>
                        <i class="fas fa-unlock-alt fa-5x mb-4 text-light"></i>
                        <h3><i class="fas fa-graduation-cap me-2"></i>COMPUTER LAB</h3>
                        <p>Hệ thống sẽ gửi email hướng dẫn đặt lại mật khẩu đến địa chỉ email của bạn.</p>
                        <p>Vui lòng kiểm tra hộp thư đến sau khi gửi yêu cầu.</p>
                    </div>
                </div>
            </div>
        </div>
