...
<head>
    ...
    <title>Đặt lại mật khẩu - Hệ thống quản lý phòng máy</title>
...
<body>
    <div class="reset-container">
        <div class="card">
            <div class="row g-0">
                <div class="col-md-6 reset-side">
                    <div class="card-body">
                        <div class="text-center mb-4">
                            <i class="fas fa-lock-open fa-3x mb-3 text-primary"></i>
                ...
                <div class="col-md-6 image-side">
                    <div>
                        <i class="fas fa-shield-alt fa-5x mb-4 text-light"></i>
                        <h3><i class="fas fa-graduation-cap me-2"></i>COMPUTER LAB</h3>
                        <p class="mt-3"><i class="fas fa-check-circle me-2"></i>Đặt lại mật khẩu mới an toàn để bảo vệ tài khoản của bạn.</p>
                        <p><i class="fas fa-info-circle me-2"></i>Mật khẩu nên bao gồm ít nhất 8 ký tự, kết hợp chữ hoa, chữ thường, số và ký tự đặc biệt.</p>
                    </div>
                </div>
            </div>
        </div>
